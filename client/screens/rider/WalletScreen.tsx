/**
 * Rider Wallet screen — DISABLED.
 * Kept in the codebase (commented below) for possible re-enable later.
 * Riders no longer use wallet balance / this screen in the app.
 */
import React from "react";
import { View } from "react-native";

export default function WalletScreen(_props: any) {
  return <View />;
}

// ── Original WalletScreen (disabled) ────────────────────────────────────────
